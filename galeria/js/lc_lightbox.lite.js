...
(function ($) {
	...
	'<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing">'+
		'<div id="lcl_window">'+
			'<a href="javascript:void(0);" id="lcl_corner_close" title="Fechar" aria-label="close" tabindex="300"></a>'+
			'<div id="lcl_loader" class="lcl_loader_pre_first_el"><span id="lcll_1"></span><span id="lcll_2"></span></div>'+
			'<div id="lcl_nav_cmd">'+
				'<button class="lcl_icon lcl_prev" title="Anterior" aria-label="previous" tabindex="10"></button>'+
				'<button class="lcl_icon lcl_play" title="Continuar/Pausar" aria-label="play/pause" tabindex="20"></button>'+
				'<button class="lcl_icon lcl_next" title="Próximo" aria-label="next" tabindex="30"></button>'+
				'<div class="lcl_icon lcl_counter"></div>'+

				'<button class="lcl_icon lcl_right_icon lcl_close" title="Fechar" tabindex="300"></button>'+
				...
				'<button class="lcl_icon lcl_right_icon lcl_txt_toggle" title="Esconder o Texto" aria-label="toggle text" tabindex="90"></button>'+
				'<button class="lcl_icon lcl_right_icon lcl_download" title="download" aria-label="download" tabindex="80"></button>'+
				'<button class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="Alternar Miniaturas" aria-label="toggle thumbnails" tabindex="70"></button>'+
