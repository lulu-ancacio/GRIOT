...
<body>
      ...
      <div class="container">
        <div class="banner-content">
          ...
          <div class="right-image">
            ...
            <img src="../mainStyle/assets/images/Pintura.jpg" alt="Mão de artista segurando pincel fino de pintura sobre mesa de trabalho com pote de pincéis e tubos de tinta ao fundo, fotografia em preto e branco de ateliê">
  ...
  <script>
    (function() {
      ...
      s.onerror = function() {
        console.error('Failed to load VLibras plugin. Accessibility widget unavailable.');
      };
  ...
  <script>
    async function testarApi() {
      ...
      try {
        ...
        dados.forEach(pintura => {

          html += `
          <a class="elem" href="${pintura.url}" title="${pintura.titulo}"
            data-lcl-author="${pintura.autor} (${pintura.ano})">
            <span style="background-image: url('${pintura.url}');"></span>
          </a>
    `;
